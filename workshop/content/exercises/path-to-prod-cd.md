...
If you click on the Config Writer in TAP-GUI, you can see a button to open the pull request for the changes in the Git repository. that was auto-created by TAP. 
