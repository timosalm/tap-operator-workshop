VMware Tanzu Application Platform supports a **single cluster installation** where of all its components and the workloads run on, and also a **multi-cluter installation** of the following types of clusters:
